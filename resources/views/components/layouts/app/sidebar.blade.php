...
<flux:sidebar stashable sticky class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
    ...
    <a wire:navigate href="{{ route('dashboard') }}"
       class="me-5 flex items-center space-x-2 rtl:space-x-reverse lg:hidden">
        <x-app-logo/>
    </a>
    ...
    <div class="border-t border-zinc-200 dark:border-zinc-700 p-3">
        <a target="_blank" href="{{ url('https://github.com/fabyo0/pos-app/discussions') }}"
           class="flex items-center gap-2 text-sm text-zinc-500 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-200 transition-colors">
